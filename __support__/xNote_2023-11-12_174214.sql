...
-- DELIMITER ;;
-- /*!50003 CREATE*/ /*!50017 DEFINER=`qridwan_admin`@`localhost`*/ /*!50003 TRIGGER `category_delete_trigger` AFTER DELETE ON `categories` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
-- DELIMITER ;;
-- /*!50003 CREATE*/ /*!50017 DEFINER=`qridwan_admin`@`localhost`*/ /*!50003 TRIGGER `notebook_delete_trigger` AFTER DELETE ON `notebooks` FOR EACH ROW BEGIN
...
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb4  COMMENT='Tags table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-11-12 18:07:08
